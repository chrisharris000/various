data = """('2000', 'Barangaroo', 'NSW', -33.860, 151.210),
...
('2031', 'Randwick North', 'NSW', -33.910, 151.260),
...
('2035', 'Maroubra Junction', 'NSW', -33.950, 151.240),
...
('2088', 'Clifton Gardens', 'NSW', -33.760, 151.210),
('2088', 'Balmoral Beach', 'NSW', -33.760, 151.210),
...
('2097', 'Collaroy Plateau', 'NSW', -33.740, 151.300),
...
('2142', 'Granville East', 'NSW', -33.850, 151.010),
...
('2144', 'Auburn South', 'NSW', -33.850, 151.030),
...
('2148', 'Blacktown South', 'NSW', -33.790, 150.870),
...
('2154', 'Rogans Hill', 'NSW', -33.730, 151.010),
...
('2171', 'Carnes Hills', 'NSW', -33.880, 150.850),
...
('2192', 'South Belmore', 'NSW', -33.9197, 151.0896),
...
('2256', 'Woy Woy South', 'NSW', -33.500, 151.330),
...
('2291', 'Merewether Beach', 'NSW', -32.940, 151.750),
...
('2480', 'Lismore South', 'NSW', -28.610, 153.040),
...
('2770', 'Mount Druitt South', 'NSW', -33.730, 150.820),
...
matches = re.findall(r"'\d{4}', '[\w\s]*'", data)
sub_to_pcode = {}

for m in matches:
    postcode, suburb = m.split(',')
    postcode = postcode.strip("'")
    suburb = suburb.strip().strip("'")
    sub_to_pcode[suburb] = postcode

def suburb_to_postcode(suburb):
    return sub_to_pcode[suburb]
